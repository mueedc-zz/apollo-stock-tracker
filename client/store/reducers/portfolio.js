...
export const addStock = stock => dispatch =>
  axios.post(`/api/portfolio`, stock)
    .then(res => {
...
export default function (state = [], action) {
  switch(action.type) {
    ...
    case UPDATE_PORTFOLIO:
      return state.map(stock => (stock.symbol === action.stock.symbol ? action.stock: stock))
